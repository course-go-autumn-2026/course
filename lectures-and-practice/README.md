...
Здесь лежат презентации к занятиям и конспекты. Выкладываем после того, как лекция прошла, поэтому
...
- [Практика 2: PostgreSQL из Go](02-Database-practice/) — задания и стартовый код.
