...
Лабораторные работы — 60 баллов из 123: остальные набираются на практических
занятиях, на лекциях и на экзамене. Как считается оценка целиком — в
[`docs/grading.md`](docs/grading.md). Плюс задания со звёздочкой: по всем
работам их на 8 баллов сверх основных.
...
Слайды и записи занятий — в [`lectures-and-practice/`](../lectures-and-practice/).
...
lectures-and-practice/   слайды и записи занятий
